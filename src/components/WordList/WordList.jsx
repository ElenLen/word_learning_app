      ...
      <tbody>
        {words.map(word => (
          <tr key={word.id}>
            {editing === word.id ? (
              <>
                <td><input name="english" value={editData.english} onChange={handleChange} /></td>
                <td><input name="transcription" value={editData.transcription} onChange={handleChange} /></td>
                <td><input name="russian" value={editData.russian} onChange={handleChange} /></td>
                {/* <td><input name="theme" value={editData.tags} onChange={handleChange} /></td> */}
                <td>
                  <button onClick={() => handleSave(word.id)} title="Сохранить">
              ...
              <>
                ...
                {/* <td>{word.tags}</td> */}
                <td>
                  <button onClick={() => handleEdit(word.id)} title="Редактировать">
                  ...
                  <button onClick={() => handleDelete(word.id)} title="Удалить">
                    <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="20">
